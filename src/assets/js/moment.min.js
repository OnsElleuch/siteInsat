...
(function (a) {
    ...
    (c = a._w),
      null != c.GG || null != c.W || null != c.E
        ...
        : ((g = a._locale._week.dow),
          ...
          (e = b(c.w, 1)),
          null != c.d ? ((f = c.d), g > f && ++e) : (f = null != c.e ? c.e + g : g)),
      (i = kb(d, e, f, h, g)),
      (a._a[Cb] = i.year),
  ...
  function W(a) {
    var b;
    a._d ||
      ((b = A(a._i)), (a._a = [b.year, b.month, b.day || b.date, b.hour, b.minute, b.second, b.millisecond]), V(a));
  }
  function X(a) {
    var b = new Date();
    return a._useUTC
    ...
    return (
      ...
      null === d || (e === a && '' === d)
        ...
        : ('string' == typeof d && (b._i = d = b._locale.preparse(d)),
          vb.isMoment(d)
            ? new m(d, !0)
            : (e ? (w(e) ? _(b) : Y(b)) : db(b), (c = new m(b)), c._nextDay && (c.add(1, 'd'), (c._nextDay = a)), c))
    );
  }
  function mb(a, b) {
    var c, d;
  ...
  function nb(a, b) {
    ...
    return 'string' == typeof b && ((b = a.localeData().monthsParse(b)), 'number' != typeof b)
      ? a
      : ((c = Math.min(a.date(), D(a.year(), b))), a._d['set' + (a._isUTC ? 'UTC' : '') + 'Month'](b, c), a);
  }
  function ob(a, b) {
  ...
  for (
    var vb,
      ...
      sc = {},
      tc = ['months', 'monthsShort', 'weekdays', 'weekdaysShort', 'weekdaysMin'],
      uc = !1;
    pc.length;
  ...
  (rc.DDDD = h(rc.DDD, 3)),
    ...
    (vb.duration = function (a, b) {
      ...
      return (
        vb.isDuration(a)
          ...
          : (i = Nb.exec(a))
          ? ((d = '-' === i[1] ? -1 : 1),
            (h = { y: 0, d: C(i[Eb]) * d, h: C(i[Fb]) * d, m: C(i[Gb]) * d, s: C(i[Hb]) * d, ms: C(i[Ib]) * d }))
          : (i = Ob.exec(a))
          ? ((d = '-' === i[1] ? -1 : 1),
            (f = function (a) {
            ...
            (h = { y: f(i[2]), M: f(i[3]), d: f(i[4]), h: f(i[5]), m: f(i[6]), s: f(i[7]), w: f(i[8]) }))
          : null == h
          ? (h = {})
          : 'object' == typeof h &&
            ('from' in h || 'to' in h) &&
            ((g = t(vb(h.from), vb(h.to))), (h = {}), (h.ms = g.milliseconds), (h.M = g.months)),
        (e = new n(h)),
    ...
    (vb.locale = function (a, b) {
      ...
      return (
        a &&
          ((c = 'undefined' != typeof b ? vb.defineLocale(a, b) : vb.localeData(a)),
      ...
      diff: function (a, b, c) {
        ...
        return (
          ...
          'year' === b || 'month' === b || 'quarter' === b
            ? ((e = j(this, f)), 'quarter' === b ? (e /= 3) : 'year' === b && (e /= 12))
            : ((d = this - f),
              (e =
                'second' === b
                  ? d / 1e3
            ...
            d !== a &&
              (!b || this._changeInProgress
                ...
                : this._changeInProgress ||
                  ((this._changeInProgress = !0), vb.updateOffset(this, !0), (this._changeInProgress = null))),
            this)
          : this._isUTC
          ? d
          : this._dateUtcOffset();
    ...
    o((vb.duration.fn = n.prototype), {
      ...
      as: function (a) {
        ...
        if (((a = z(a)), 'month' === a || 'year' === a))
          return (
            (b = this._days + this._milliseconds / 864e5), (c = this._months + 12 * rb(b)), 'month' === a ? c : c / 12
          );
