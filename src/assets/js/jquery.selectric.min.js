    ...
    c = function (n, c) {
      function d(t) {
        ...
        e.each(a, function (e, t) {
          ...
          (D = e('<div/>', { class: o.prefix, html: j.options.arrowButtonMarkup })),
          (I = e('<p class="label"/>')),
      ...
      function p() {
        ...
        (B = S = ~i ? i : 0),
          (E = t.length) &&
            (t.each(function () {
              function t() {
                ...
                (j.items[n] = { element: t, value: t.val(), text: o, slug: l.replaceDiacritics(o), disabled: i }),
                  (s += l.format(
                    '<li data-index="{1}" class="{2}">{3}</li>',
                    n,
                    e.trim([n == B ? 'selected' : '', n == E - 1 ? 'last' : '', i ? 'disabled' : ''].join(' ')),
          ...
          F.prop('disabled')
            ...
            : ((R = !0),
              y.removeClass(j.classes.disabled).on('mouseenter' + o + ' mouseleave' + o, function (t) {
                e(this).toggleClass(j.classes.hover),
                  j.options.openOnHover &&
                    (clearTimeout(j.closeTimer),
                    'mouseleave' == t.type ? (j.closeTimer = setTimeout(g, j.options.hoverIntentTimeout)) : m());
              }),
      ...
      function f() {
        ...
        !j.options.expandToItemText || o > s
          ? (M = o)
          : (k.css('overflow', 'scroll'), y.width(9e4), (M = k.width()), k.css('overflow', ''), y.width('')),
