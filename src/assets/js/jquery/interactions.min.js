            ...
            !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ...
              : ('inner' !== f.snapMode &&
                ...
                !s.snapElements[c].snapping &&
                  (n || a || o || r || p) &&
                  s.options.snap.snap &&
                  s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), { snapItem: s.snapElements[c].item })),
          ...
          ? (this.element
              ...
              .each(function () {
                ...
                return i.options.greedy &&
                  ...
                  e.ui.intersect(s, e.extend(i, { offset: i.element.offset() }), i.options.tolerance, t)
                  ? ((n = !0), !1)
                  : void 0;
              }),
            n
          ...
          if (!(a[s].options.disabled || (t && !a[s].accept.call(a[s].element[0], t.currentItem || t.element)))) {
            ...
            (a[s].visible = 'none' !== a[s].element.css('display')),
              a[s].visible &&
                ...
                a[s].proportions({ width: a[s].element[0].offsetWidth, height: a[s].element[0].offsetHeight }));
          }
      },
      drop: function (t, i) {
        var s = !1;
    ...
    e.widget('ui.resizable', e.ui.mouse, {
          ...
          for (i in this.handles)
            this.handles[i].constructor === String
              ...
              : (this.handles[i].jquery || this.handles[i].nodeType) &&
                ((this.handles[i] = e(this.handles[i])), this._on(this.handles[i], { mousedown: o._mouseDown })),
      ...
      _mouseStart: function (t) {
        ...
        return (
          ...
          (this.aspectRatio =
            'number' == typeof a.aspectRatio ? a.aspectRatio : this.originalSize.width / this.originalSize.height || 1),
      ...
      _getPaddingPlusBorderDimensions: function (e) {
        for (
          var t = 0,
            ...
            n = [e.css('paddingTop'), e.css('paddingRight'), e.css('paddingBottom'), e.css('paddingLeft')];
          4 > t;
          t++
        )
      ...
      resize: function (t) {
        ...
        c[0] !== document && /static/.test(c.css('position')) && (d = h),
          l.left < (o._helper ? h.left : 0) &&
            ((o.size.width = o.size.width + (o._helper ? o.position.left - h.left : o.position.left - d.left)),
            u && ((o.size.height = o.size.width / o.aspectRatio), (p = !1)),
            (o.position.left = r.helper ? h.left : 0)),
          l.top < (o._helper ? h.top : 0) &&
            ((o.size.height = o.size.height + (o._helper ? o.position.top - h.top : o.position.top)),
          ...
          i + o.size.width >= o.parentData.width &&
            ((o.size.width = o.parentData.width - i), u && ((o.size.height = o.size.width / o.aspectRatio), (p = !1))),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)),
              ...
              p - l > 0
                ...
                : ((p = l - t.width), (i.size.width = p), (i.position.left = o.left + a.width - p)));
      },
    }),
    e.ui.resizable,
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                ('touch' === n.tolerance
                  ...
                  : 'fit' === n.tolerance && (l = i.left > a && r > i.right && i.top > o && h > i.bottom),
                l
    ...
    e.widget('ui.sortable', e.ui.mouse, {
      ...
      _setHandleClassName: function () {
        this.element.find('.ui-sortable-handle').removeClass('ui-sortable-handle'),
          e.each(this.items, function () {
            (this.instance.options.handle ? this.item.find(this.instance.options.handle) : this.item).addClass(
              'ui-sortable-handle'
            );
          });
      },
            ...
            this.options.scroll &&
              (this.scrollParent[0] !== this.document[0] && 'HTML' !== this.scrollParent[0].tagName
                ...
                : (t.pageY - this.document.scrollTop() < o.scrollSensitivity
                    ...
                    : this.window.height() - (t.pageY - this.document.scrollTop()) < o.scrollSensitivity &&
                      (r = this.document.scrollTop(this.document.scrollTop() + o.scrollSpeed)),
                  t.pageX - this.document.scrollLeft() < o.scrollSensitivity
                    ? (r = this.document.scrollLeft(this.document.scrollLeft() - o.scrollSpeed))
                    : this.window.width() - (t.pageX - this.document.scrollLeft()) < o.scrollSensitivity &&
                      (r = this.document.scrollLeft(this.document.scrollLeft() + o.scrollSpeed))),
      ...
      _intersectsWith: function (e) {
        ...
        return 'pointer' === this.options.tolerance ||
          ...
          ('pointer' !== this.options.tolerance &&
            this.helperProportions[this.floating ? 'width' : 'height'] > e[this.floating ? 'width' : 'height'])
          ? p
                ...
                o &&
                  ...
                  h.push([
                    e.isFunction(o.options.items)
                      ...
                      : e(o.options.items, o.element).not('.ui-sortable-helper').not('.ui-sortable-placeholder'),
                    o,
                  ]);
        for (
          h.push([
        ...
        (s.placeholder && s.placeholder.constructor !== String) ||
          ...
          (s.placeholder = {
            element: function () {
              ...
              return (
                'tbody' === s
                  ? t._createTrPlaceholder(t.currentItem.find('tr').eq(0), e('<tr>', t.document[0]).appendTo(n))
                  : 'tr' === s
      ...
      _createHelper: function (t) {
        ...
        return (
          s.parents('body').length ||
            e('parent' !== i.appendTo ? i.appendTo : this.currentItem[0].parentNode)[0].appendChild(s[0]),
      ...
      _getParentOffset: function () {
        ...
        return (
          ...
          (this.offsetParent[0] === this.document[0].body ||
            (this.offsetParent[0].tagName && 'html' === this.offsetParent[0].tagName.toLowerCase() && e.ui.ie)) &&
            (t = { top: 0, left: 0 }),
          {
            top: t.top + (parseInt(this.offsetParent.css('borderTopWidth'), 10) || 0),
            left: t.left + (parseInt(this.offsetParent.css('borderLeftWidth'), 10) || 0),
      ...
      _convertPositionTo: function (t, i) {
        ...
        var s = 'absolute' === t ? 1 : -1,
          n =
            'absolute' !== this.cssPosition ||
            (this.scrollParent[0] !== this.document[0] && e.contains(this.scrollParent[0], this.offsetParent[0]))
              ? this.scrollParent
              : this.offsetParent,
