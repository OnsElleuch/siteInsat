...
!(function (a) {
  ...
  function d(b) {
    ...
    return (
      a.each(b, function (b, e) {
        'views' != b &&
          (a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Oa)
            ? ((c = null),
  ...
  function A(b) {
    var c,
      ...
      f = [];
    for (
      'string' == typeof b ? (f = b.split(/\s*,\s*/)) : 'function' == typeof b ? (f = [b]) : a.isArray(b) && (f = b),
        c = 0;
      c < f.length;
      c++
    )
      (d = f[c]),
        'string' == typeof d
          ? e.push('-' == d.charAt(0) ? { field: d.substring(1), order: -1 } : { field: d, order: 1 })
  ...
  function M(a, c) {
    ...
    return N(a)
      ? b.duration(a * c)
      : ((d = a.asMonths()),
        Math.abs(d) >= 1 && ba(d) ? b.duration({ months: d * c }) : b.duration({ days: a.asDays() * c }));
  }
  function N(a) {
      ...
      b.isMoment(j)
        ...
        : ((f = !1),
          ...
          k
            ? Wa.test(j)
              ? ((j += '-01'), (c = [j]), (f = !0), (g = !0))
              : (h = Xa.exec(j)) && ((f = !h[5]), (g = !0))
            : a.isArray(j) && (g = !0),
          (i = d || f ? b.utc.apply(b, c) : b.apply(null, c)),
          f
            ? ((i._ambigTime = !0), (i._ambigZone = !0))
            : e && (g ? (i._ambigZone = !0) : k && (i.utcOffset ? i.utcOffset(j) : i.zone(j)))),
      (i._fullCalendar = !0),
      i
    );
  }
  ...
  function qa(a) {
    for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; (b = d.exec(a)); )
      b[1] ? c.push(b[1]) : b[2] ? c.push({ maybe: qa(b[2]) }) : b[3] ? c.push({ token: b[3] }) : b[5] && c.push(b[5]);
    return c;
  }
  function ra() {}
  function sa(a, b) {
  ...
  function Ga(c, d) {
    ...
    function f() {
      (V = O.theme ? 'ui' : 'fc'),
        ...
        T && c.prepend(T),
        i(O.defaultView),
        O.handleWindowResize && ((Y = da(m, O.windowResizeDelay)), a(window).resize(Y));
    }
    function g() {
      W && W.removeElement(),
        S.removeElement(),
    ...
    function i(b) {
      ca++,
        W && b && W.type !== b && (S.deactivateButton(W.type), H(), W.removeElement(), (W = N.view = null)),
        !W &&
          b &&
    ...
    function L(a, b) {
      return void 0 === b
        ? O[a]
        : void (('height' == a || 'contentHeight' == a || 'aspectRatio' == a) && ((O[a] = b), j(!0)));
    }
    function M(a, b) {
    ...
    (P._fullCalendar_weekCalc = (function (a) {
      ...
      (N.moment = function () {
        ...
        return (
          'local' === O.timezone
            ? ((a = Ma.moment.apply(null, arguments)), a.hasTime() && a.local())
            : (a =
                'UTC' === O.timezone
                  ? Ma.moment.utc.apply(null, arguments)
      ...
      (N.getDefaultEventEnd = function (a, b) {
        var c = b.clone();
        return (
          a ? c.stripTime().add(N.defaultAllDayEventDuration) : c.add(N.defaultTimedEventDuration),
            ...
            a.each(this.split(','), function (d, e) {
                    ...
                    (s = a('<button type="button" class="' + r.join(' ') + '">' + q + '</button>')
                      .click(function (a) {
                        s.hasClass(n + '-state-disabled') ||
                          (j(a),
                          (s.hasClass(n + '-state-active') || s.hasClass(n + '-state-disabled')) &&
              ...
              h &&
                g
                  ...
                  .end(),
              g.length > 1
                ? ((f = a('<div/>')), h && f.addClass('fc-button-group'), f.append(g), e.append(f))
                : e.append(g);
          }),
        e
      );
  ...
  function Ka(c) {
    ...
    function p(a, b) {
      ...
      if (f) {
        for (c = x(f), d = 0; d < c.length; d++)
          (e = c[d]), e.source || (b && (Q.events.push(e), (e.source = Q)), U.push(e));
        return O(U), c;
      }
      return [];
    }
    ...
    function s(d, e) {
      ...
      if (
        ...
        g && ((g = L.moment(g)), g.isValid() || (g = null)),
          (h = d.allDay),
    ...
    function v(a) {
      null == a.allDay && (a.allDay = !(a.start.hasTime() || (a.end && a.end.hasTime()))),
        a.allDay
          ...
          : (a.start.hasTime() || (a.start = L.rezoneDate(a.start)),
    ...
    function A(b) {
      ...
      return (
        ...
        d ? (b && ((d.start = null), (d.end = null)), x(s(d), g.start, g.end)) : []
      );
    }
    function B(a, b) {
      var d = b.source || {},
    ...
    function E(b, c, d, e) {
      var f, g, h, i, j, k;
      if (
        ((b = a.extend({}, b)), (b.start = b.start.clone().stripZone()), (b.end = b.end.clone().stripZone()), null != c)
      ) {
  ...
  var Ma = (a.fullCalendar = { version: '2.4.0' }),
    Na = (Ma.views = {});
    ...
    return (
      this.each(function (e, f) {
        ...
        'string' == typeof b
          ? i &&
            a.isFunction(i[b]) &&
            ((g = i[b].apply(i, c)), e || (d = g), 'destroy' === b && h.removeData('fullCalendar'))
          : i || ((i = new nb(h, b)), h.data('fullCalendar', i), i.render());
      }),
      d
    );
  };
  ...
  var Qa = ['SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY'],
  ...
  (Ma.moment = function () {
    ...
    (Ya.week = Ya.weeks = function (a) {
      ...
      return null == a && 'function' == typeof b
        ? b(this)
        : 'ISO' === b
        ? Za.isoWeek.apply(this, arguments)
        : Za.week.apply(this, arguments);
    }),
    (Ya.time = function (a) {
    ...
    (Ya.stripTime = function () {
      ...
      return (
        this._ambigTime ||
          ((a = this.toArray()), this.utc(), Ta(this, a.slice(0, 3)), (this._ambigTime = !0), (this._ambigZone = !0)),
        this
      );
    }),
    (Ya.hasTime = function () {
    ...
    (Ya.format = function () {
      return this._fullCalendar && arguments[0]
        ...
        : Za.format.apply(this, arguments);
    }),
    (Ya.toISOString = function () {
      return this._ambigTime
        ...
        : this._ambigZone
        ? ia(this, 'YYYY-MM-DD[T]HH:mm:ss')
        : Za.toISOString.apply(this, arguments);
    }),
    ...
    (Ya.isSame = function (a, b) {
      ...
      return this._fullCalendar
        ? b
          ? ((c = fa([this, a], !0)), Za.isSame.call(c[0], c[1], b))
          : ((a = Ma.moment.parseZone(a)),
            Za.isSame.call(this, a) &&
              Boolean(this._ambigTime) === Boolean(a._ambigTime) &&
              Boolean(this._ambigZone) === Boolean(a._ambigZone))
        : Za.isSame.apply(this, arguments);
    }),
  ...
  var bb = (Ma.Emitter = ra.extend({
    ...
    cb = ra.extend({
      ...
      show: function () {
        this.isHidden &&
          (this.el || this.render(), this.el.show(), this.position(), (this.isHidden = !1), this.trigger('show'));
      },
      hide: function () {
    ...
    fb = (Ma.DragListener = ra.extend({
      ...
      startListening: function (b) {
        ...
        this.isListening ||
          ...
          b ? ((this.originX = b.pageX), (this.originY = b.pageY)) : ((this.originX = 0), (this.originY = 0)),
          (this.isListening = !0),
          this.listenStart(b));
      },
      ...
      stopListening: function (b) {
        this.stopDrag(b),
          this.isListening &&
            (this.scrollEl && (this.scrollEl.off('scroll', this.scrollHandlerProxy), (this.scrollHandlerProxy = null)),
            a(document)
      ...
      setScrollVel: function (a, b) {
        (this.scrollTopVel = a),
          ...
          (!this.scrollTopVel && !this.scrollLeftVel) ||
            ...
            (this.scrollIntervalId = setInterval(ca(this, 'scrollIntervalFunc'), this.scrollIntervalMs));
      },
      ...
      stopScrolling: function () {
        this.scrollIntervalId &&
          (clearInterval(this.scrollIntervalId), (this.scrollIntervalId = null), this.scrollStop());
      },
    ...
    gb = fb.extend({
        ...
        fb.prototype.listenStart.apply(this, arguments),
          ...
          a
            ? ((c = { left: a.pageX, top: a.pageY }),
              ...
              e && this.options.subjectCenter && (this.origCell && (b = w(this.origCell, b) || b), (d = y(b))),
      ...
      drag: function (a, b, c) {
        ...
        fb.prototype.drag.apply(this, arguments),
          ...
          sa(d, this.cell) || (this.cell && this.cellOut(), d && this.cellOver(d));
      },
      dragStop: function () {
      ...
      getCell: function (a, b) {
        return (
          this.coordAdjust && ((a += this.coordAdjust.left), (b += this.coordAdjust.top)), this.coordMap.getCell(a, b)
        );
      },
    }),
    hb = ra.extend({
      ...
      stop: function (b, c) {
        ...
        this.isFollowing &&
          ...
          b && f && !this.isHidden
            ? ((this.isAnimating = !0),
              this.el.animate({ top: this.top0, left: this.left0 }, { duration: f, complete: d }))
            : d());
      },
      getEl: function () {
        var a = this.el;
    ...
    jb = (Ma.Grid = ib.extend({
      ...
      computeSelection: function (a, b) {
        ...
        return (
          d.sort(aa),
          (c = { start: d[0].clone(), end: d[3].clone() }),
  ...
  jb.mixin({
      ...
      return (
        g.hasTime() === h.hasTime()
          ? ((d = this.diffDates(h, g)),
            c.allDay && N(d)
              ? ((e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }), f.normalizeEventRangeTimes(e))
              : (e = { start: c.start.clone(), end: c.end ? c.end.clone() : null, allDay: c.allDay }),
            e.start.add(d),
            e.end && e.end.add(d))
    ...
    computeEventResize: function (a, b, c, d) {
      ...
      return (
        ...
        e.allDay && N(h) && ((e.allDay = !1), g.normalizeEventRangeTimes(e)),
        e[a].add(h),
        e.start.isBefore(e.end) ||
          ((f = d.allDay ? g.defaultAllDayEventDuration : g.defaultTimedEventDuration),
    ...
    getSegClasses: function (a, b, c) {
      var d = a.event,
        e = ['fc-event', a.isStart ? 'fc-start' : 'fc-not-start', a.isEnd ? 'fc-end' : 'fc-not-end'].concat(
          d.className,
          d.source ? d.source.className : []
        );
    ...
    eventsToNormalRanges: function (a) {
      ...
      for (b = 0; b < a.length; b++)
        (c = a[b]),
          ...
          g.push({ event: c, start: d, end: e, eventStartMS: +d, eventDurationMS: e - d });
      return g;
    },
    eventsToInverseRanges: function (a) {
      var b,
        ...
        i = a[0],
        j = e;
      for (g.sort(xa), b = 0; b < g.length; b++)
    ...
    eventRangeToSegs: function (a, b) {
      var c, d, e;
      for (
        a = this.view.calendar.ensureVisibleEventRange(a), c = b ? b(a) : this.rangeToSegs(a), d = 0;
        d < c.length;
        d++
      )
  ...
  var kb = jb.extend({
    ...
    renderDates: function (a) {
      ...
      for (
        this.el.html(i), this.rowEls = this.el.find('.fc-row'), this.dayEls = this.el.find('.fc-day'), c = 0;
        h > c;
        c++
      )
    ...
    updateCellDates: function () {
      for (var a = this.view, b = this.start.clone(), c = [], d = -1, e = []; b.isBefore(this.end); )
        a.isHiddenDay(b) ? e.push(d + 0.5) : (d++, e.push(d), c.push(b.clone())), b.add(1, 'days');
      ...
      for (
        ...
        (e = d * n),
          ...
          j >= i &&
            ...
            (i -= e),
            (j -= e),
            (k = { row: d, isStart: g, isEnd: h }),
            l ? ((k.leftCol = n - j - 1), (k.rightCol = n - i - 1)) : ((k.leftCol = i), (k.rightCol = j)),
            o.push(k));
      return o;
    },
    ...
    renderDrag: function (a, b) {
      return (
        ...
        b && !b.el.closest(this.el).length
          ? (this.renderRangeHelper(a, b), this.applyDragOpacity(this.helperEls), !0)
          : void 0
      );
    },
    unrenderDrag: function () {
  ...
  kb.mixin({
    ...
    fgSegHtml: function (a, b) {
      ...
      return (
        ...
        a.isStart && ((c = this.getEventTimeText(f)), c && (l = '<span class="fc-time">' + Y(c) + '</span>')),
    ...
    renderSegRow: function (b, c) {
      function d(b) {
        for (; b > g; )
          (k = (r[e - 1] || [])[g]),
            k ? k.attr('rowspan', parseInt(k.attr('rowspan') || 1, 10) + 1) : ((k = a('<td/>')), h.append(k)),
            (q[e][g] = k),
            (r[e][g] = k),
            g++;
      }
          ...
          for (i = 0; i < f.length; i++) {
            for (
              j = f[i],
                ...
                j.leftCol != j.rightCol ? k.attr('colspan', j.rightCol - j.leftCol + 1) : (r[e][g] = k);
              g <= j.rightCol;
      ...
      renderMoreLink: function (b, c) {
        ...
        return a('<a class="fc-more"/>')
          ...
          .on('click', function (f) {
            ...
            'function' == typeof g &&
              (g = e.trigger('eventLimitClick', null, { date: h, dayEl: j, moreEl: i, segs: l, hiddenSegs: m }, f)),
  ...
  var lb = jb.extend({
    ...
    rangeToSegs: function (a) {
      ...
      for (a = { start: a.start.clone().stripZone(), end: a.end.clone().stripZone() }, c = 0; f > c; c++)
        (d = this.colDates[c]),
          (e = { start: d.clone().time(this.minTime), end: d.clone().time(this.maxTime) }),
          (b = E(a, e)),
          b && ((b.col = c), g.push(b));
      return g;
    },
    ...
    renderDrag: function (a, b) {
      return b
        ? (this.renderRangeHelper(a, b), this.applyDragOpacity(this.helperEl), !0)
      ...
      if (c.length) {
        for (
          ...
          if (((i = e[h]), (j = a('<td/>').appendTo(g)), i.length))
            for (
              k = a('<div class="fc-' + d + '-container"/>').appendTo(j), l = this.colDates[h], m = 0;
              m < i.length;
              m++
            )
              (n = i[m]),
                k.append(n.el.css({ top: this.computeDateTop(n.start, l), bottom: -this.computeDateTop(n.end, l) }));
  ...
  lb.mixin({
    ...
    renderSegTable: function (b) {
      ...
      for (c = this.groupSegCols(b), this.computeSegVerticals(b), f = 0; f < c.length; f++) {
        for (g = c[f], this.placeSlotSegs(g), h = a('<div class="fc-event-container"/>'), d = 0; d < g.length; d++)
          (e = g[d]),
    ...
    fgSegHtml: function (a, b) {
      ...
      return (
        ...
        '<a class="' +
          ...
          '><div class="fc-content">' +
          (c
            ? '<div class="fc-time" data-start="' + Y(e) + '" data-full="' + Y(d) + '"><span>' + Y(c) + '</span></div>'
            : '') +
  ...
  var mb = (Ma.View = ra.extend({
      ...
      computeRange: function (a) {
        ...
        return (
          /year|month|week|day/.test(d)
            ...
            : (e.hasTime() || (e = this.calendar.rezoneDate(e)), f.hasTime() || (f = this.calendar.rezoneDate(f))),
          (b = e.clone()),
      ...
      documentMousedown: function (b) {
        ...
        this.isSelected &&
          ...
          v(b) &&
          ((c = this.opt('unselectCancel')), (c && a(b.target).closest(c).length) || this.unselect(b));
      },
      ...
      computeDayRange: function (a) {
        var b,
          ...
          e = null;
        return (
          d && ((e = d.clone().stripTime()), (b = +d.time()), b && b >= this.nextDayThreshold && e.add(1, 'days')),
        ...
        return (
          ...
          d['class']
            ? (f &&
                ((f = b.duration(f)),
                f.valueOf() &&
                  ((d.duration = f), (g = I(f)), 1 === f.as(g) && ((d.singleUnit = g), k.unshift(h[g] || {})))),
              (d.defaults = c(j)),
              (d.overrides = c(k)),
  ...
  nb.mixin(bb),
    ...
    (nb.englishDefaults = { dayPopoverFormat: 'dddd, MMMM D' }),
    (nb.rtlDefaults = {
  ...
  var ub = mb.extend({
      ...
      computeRange: function (a) {
        ...
        return (
          /year|month/.test(b.intervalUnit) &&
            ...
            b.end.weekday() && (b.end.add(1, 'week').startOf('week'), (b.end = this.skipHiddenDays(b.end, -1, !0)))),
          b
        );
      },
      renderDates: function () {
      ...
      dayIntroHtml: function () {
        return this.weekNumbersVisible
          ? '<td class="fc-week-number ' + this.widgetContentClass + '" ' + this.weekNumberStyleAttr() + '></td>'
          : void 0;
      },
      introHtml: function () {
      ...
      numberCellHtml: function (a) {
        ...
        return this.dayNumbersVisible
          ? ((b = this.dayGrid.getDayClasses(c)),
            ...
            '<td class="' + b.join(' ') + '" data-date="' + c.format() + '">' + c.date() + '</td>')
          : '<td/>';
      },
      ...
      setHeight: function (a, b) {
        ...
        m(this.scrollerEl),
          ...
          !b &&
            l(this.scrollerEl, c) &&
            (e(this.headRowEl, r(this.scrollerEl)), (c = this.computeScrollerHeight(a)), this.scrollerEl.height(c));
      },
    ...
    vb = ub.extend({
      computeRange: function (a) {
        var b,
          c = ub.prototype.computeRange.call(this, a);
  ...
  (Na.basic = { class: ub }),
    (Na.basicDay = { type: 'basic', duration: { days: 1 } }),
    (Na.basicWeek = { type: 'basic', duration: { weeks: 1 } }),
  ...
  var wb = mb.extend({
      ...
      initialize: function () {
        (this.timeGrid = new lb(this)),
          this.opt('allDaySlot')
            ? ((this.dayGrid = new kb(this)), (this.coordMap = new eb([this.dayGrid.coordMap, this.timeGrid.coordMap])))
        ...
        return this.opt('weekNumbers')
          ? ((a = this.timeGrid.getCell(0).start),
            ...
            '<th class="fc-axis fc-week-number ' +
              ...
              Y(b) +
              '</span></th>')
          : '<th class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + '></th>';
      },
      dayIntroHtml: function () {
        return (
          '<td class="fc-axis ' +
          ...
          this.axisStyleAttr() +
          '><span>' +
          (this.opt('allDayHtml') || Y(this.opt('allDayText'))) +
          '</span></td>'
        );
      },
        ...
        null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()),
          ...
          b ||
            ...
            l(this.scrollerEl, d)
              ...
              : (this.scrollerEl.height(d).css('overflow', 'hidden'), this.bottomRuleEl.show()));
      },
    ...
    xb = 5,
    yb = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
  return (
    (Na.agenda = {
      class: wb,
      defaults: {
    ...
    (Na.agendaDay = { type: 'agenda', duration: { days: 1 } }),
    (Na.agendaWeek = { type: 'agenda', duration: { weeks: 1 } }),
    Ma
  );
});
