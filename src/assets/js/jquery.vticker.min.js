    ...
    c = {
      ...
      animate: function (a, b, e) {
        ...
        if (b && b.animate) {
          ...
          a.animating = !0;
          g.animate('up' === e ? { top: '-=' + c + 'px' } : { top: 0 }, f.speed, function () {
      ...
      nextUsePause: function () {
        var a = d(this).data('state'),
          b = a.options;
        a.isPaused || 2 > a.itemCount || f.next.call(this, { animate: b.animate });
      },
    ...
    f = {
      init: function (a) {
        ...
        b.css({ overflow: 'hidden', position: 'relative' })
          ...
          .children('li')
          .css({ margin: a.margin, padding: a.padding });
        isNaN(a.height) || 0 === a.height
          ? (b
              .children('ul')
              .children('li')
              .each(function () {
          ...
          b
            ...
            .bind('mouseleave', function () {
              if (!0 !== e.isPaused || e.pausedByCode)
                (e.pausedByCode = !1), f.pause.call(h, !1), c.startInterval.call(h);
            });
      },
      pause: function (a) {
        ...
        if (b) {
          ...
          b = b.element;
          a
            ? (d(this).addClass('paused'), b.trigger('vticker.pause'))
            : (d(this).removeClass('paused'), b.trigger('vticker.resume'));
        }
      },
      next: function (a) {
        var b = d(this).data('state');
