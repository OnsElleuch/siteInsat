...
!(function (e) {
  function t() {
    ...
    return (
      (hashtag =
        -1 !== e.indexOf('#prettyPhoto') ? decodeURI(e.substring(e.indexOf('#prettyPhoto') + 1, e.length)) : !1),
    ...
    (e.fn.prettyPhoto = function (a) {
      function s() {
        e('.pp_loaderIcon').hide(),
          ...
          $pp_pic_holder
            .find('.pp_content')
            .animate({ height: f.contentHeight, width: f.contentWidth }, settings.animation_speed),
        ...
        if (
          ...
          for (var t = 0; t < pp_images.length; t++)
            pp_images[t].match(/\b(jpg|jpeg|png|gif)\b/gi)
              ...
              (toInject +=
                "<li class='" + classname + "'><a href='#'><img src='" + img_src + "' width='50' alt='' /></a></li>");
            ...
            e('a.pp_expand').bind('click', function () {
              return (
                e(this).hasClass('pp_expand')
                  ? (e(this).removeClass('pp_expand').addClass('pp_contract'), (doresize = !1))
                  : (e(this).removeClass('pp_contract').addClass('pp_expand'), (doresize = !0)),
                n(function () {
                  e.prettyPhoto.open();
                }),
                !1
      ...
      return (
        ...
        (e.prettyPhoto.open = function (t) {
          return (
            ...
            -1 != movie_height.indexOf('%') &&
              ((movie_height = parseFloat((e(window).height() * parseFloat(movie_height)) / 100 - 150)), ($ = !0)),
            -1 != movie_width.indexOf('%') &&
              ((movie_width = parseFloat((e(window).width() * parseFloat(movie_width)) / 100 - 150)), ($ = !0)),
            $pp_pic_holder.fadeIn(function () {
              switch (
                ($ppt.html(
                  settings.show_title && '' != pp_titles[set_position] && 'undefined' != typeof pp_titles[set_position]
        ...
        (e.prettyPhoto.changePage = function (t) {
          (currentGalleryPage = 0),
            'previous' == t
              ? (set_position--, set_position < 0 && (set_position = e(pp_images).size() - 1))
              : 'next' == t
              ? (set_position++, set_position > e(pp_images).size() - 1 && (set_position = 0))
              : (set_position = t),
