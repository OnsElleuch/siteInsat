  ...
  e.fn.masonry = function (j, l) {
    var g = {
      getBricks: function (d, b, a) {
        ...
        b.$bricks =
          a.appendedContent === undefined
            ? c
              ? d.children()
              : d.find(a.itemSelector)
            : c
            ? a.appendedContent
            : a.appendedContent.filter(a.itemSelector);
      },
      placeBrick: function (d, b, a, c, h) {
        b = Math.min.apply(Math, a);
        for (var i = b + d.outerHeight(true), f = a.length, k = f, m = c.colCount + 1 - f; f--; ) if (a[f] == b) k = f;
      ...
      setup: function (d, b, a) {
        ...
        a.colW =
          b.columnWidth === undefined ? (a.masoned ? a.previousData.colW : a.$bricks.outerWidth(true)) : b.columnWidth;
    ...
    return this.each(function () {
      ...
      !h &&
        c.resizeable &&
        e(window).bind('smartresize.masonry', function () {
          g.resize(d, c, b);
        });
