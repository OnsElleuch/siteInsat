    ...
    return this.each(function () {
      var e = t(this),
        ...
        o = function () {
          ...
          o = o.replace(/,/g, '');
          for (
            var l = (/^[0-9]+$/.test(o), /^[0-9]+\.[0-9]+$/.test(o)), u = l ? (o.split('.')[1] || []).length : 0, s = n;
            s >= 1;
            s--
          ) {
  ...
  function () {
    ...
    !(function (t, e) {
      ...
      return (
        ...
        (i = (function () {
          ...
          return (
                  ...
                  return (
                    ...
                    n.each(e.waypoints[t], function (t, e) {
                      ...
                      return r.oldScroll < (n = e.offset) && n <= r.newScroll
                        ? l.push(e)
                        : r.newScroll < (o = e.offset) && o <= r.oldScroll
                        ? l.push(e)
                        : void 0;
                    }),
                    l.sort(function (t, e) {
                ...
                n.each(t, function (t, e) {
                  return n.each(o.waypoints[t], function (t, r) {
                    ...
                    return (
                      ...
                      (r.options.onlyOnScroll && null != l) || !r.enabled
                        ? void 0
                        : null !== l && l < (u = e.oldScroll) && u <= r.offset
                        ? r.trigger([e.backward])
                        : null !== l && l > (s = e.oldScroll) && s >= r.offset
                        ? r.trigger([e.forward])
            ...
            (t.prototype.checkEmpty = function () {
              return n.isEmptyObject(this.waypoints.horizontal) && n.isEmptyObject(this.waypoints.vertical)
                ? (this.$element.unbind([p, v].join(' ')), delete c[this.id])
                : void 0;
            }),
            t
          );
        ...
        (l = (function () {
          function t(t, e, r) {
            ...
            (r = n.extend({}, n.fn[m].defaults, r)),
              'bottom-in-view' === r.offset &&
                (r.offset = function () {
                  var t;
                  return (
                    (t = n[w]('viewportHeight')),
        ...
        (n.fn[m].defaults = { context: r, continuous: !0, enabled: !0, horizontal: !1, offset: 0, triggerOnce: !1 }),
        (d = {
          refresh: function () {
        ...
        (n[w].settings = { resizeThrottle: 100, scrollThrottle: 30 }),
        o.load(function () {
          return n[w]('refresh');
        })
      );
